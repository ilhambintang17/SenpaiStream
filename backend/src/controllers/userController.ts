...
// Watchlist
export const getWatchlist = async (req: any, res: Response, next: NextFunction) => {
    try {
...
export const addToWatchlist = async (req: any, res: Response, next: NextFunction) => {
    try {
        ...
        const item = await Watchlist.findOneAndUpdate(
            ...
            { userId: req.user.id, animeId, animeTitle, animePoster, source, addedAt: new Date() },
...
export const removeFromWatchlist = async (req: any, res: Response, next: NextFunction) => {
    try {
...
export const checkWatchlistStatus = async (req: any, res: Response, next: NextFunction) => {
    try {
        const { animeId } = req.params;
...
export const updateHistory = async (req: any, res: Response, next: NextFunction) => {
    try {
...
export const removeFromFavorites = async (req: any, res: Response, next: NextFunction) => {
    try {
        const { animeId } = req.params;
...
export const checkFavoriteStatus = async (req: any, res: Response, next: NextFunction) => {
    try {
        const { animeId } = req.params;
...
// Ratings
export const setRating = async (req: any, res: Response, next: NextFunction) => {
    try {
        const { animeId, rating, review } = req.body;
        const item = await Rating.findOneAndUpdate(
            { userId: req.user.id, animeId },
            { userId: req.user.id, animeId, rating, review },
            { upsert: true, new: true, setDefaultsOnInsert: true }
        );
        res.json(item);
    } catch (error) {
...
export const getUserRating = async (req: any, res: Response, next: NextFunction) => {
    try {
        const { animeId } = req.params;
...
export const getAnimeRatingStats = async (req: Request, res: Response, next: NextFunction) => {
    try {
        const { animeId } = req.params;
